...
VaxMate è un'applicazione mobile in grado di fornire indicazioni vaccinali nei pazienti in terapia biologica. Progettata come sistema di supporto decisionale, l'app combina un'area di consultazione pubblica basata su linee guida cliniche e un'area riservata per la gestione degli inventari ospedalieri.

Il progetto simula lo sviluppo di un'applicazione medica reale, con un forte focus sull'usabilità clinica, la correttezza dei calcoli e la robustezza dell'interfaccia.
...
* **Linguaggio:** Kotlin
* **IDE:** Android Studio
* **Architettura:** Modellazione di linee guida cliniche tramite regole logiche e tabelle decisionali.
